...
def add_book(request):
    """
    View that allows adding a new book.
    Requires 'relationship_app.can_add_book' permission.
    """
    if request.method == "POST":
...
def edit_book(request, pk):
    """
    View that allows editing an existing book.
    Requires 'relationship_app.can_change_book' permission.
    """
...
def delete_book(request, pk):
    """
    View that allows deleting an existing book.
    Requires 'relationship_app.can_delete_book' permission.
    """
    from .models import Book
    book = get_object_or_404(Book, pk=pk)
    if request.method == "POST":
